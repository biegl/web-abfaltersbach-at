        ...
        <CRow>
            ...
            <CCol xs="12" md="6">
                <CCard>
                    <CCardHeader>
                        Switch
                        <small
                            ><code>variant="outline" shape="pill"</code></small
                        >
                    </CCardHeader>
                    <CCardBody>
                        <CSwitch
            ...
            <CCol xs="12" md="6">
                <CCard>
                    <CCardHeader>
                        Switch
                        <small
                            ><code>variant="opposite" shape="pill"</code></small
                        >
                    </CCardHeader>
                    <CCardBody>
                        <CSwitch
            ...
            <CCol xs="12" md="6">
                <CCard>
                    <CCardHeader>
                        Switch
                        <small><code>label variant="outline"</code></small>
                    </CCardHeader>
                    <CCardBody>
                        <CSwitch
                            class="mx-1"
            ...
            <CCol xs="12" md="6">
                <CCard>
                    <CCardHeader>
                        Switch
                        <small><code>label variant="opposite"</code></small>
                    </CCardHeader>
                    <CCardBody>
                        <CSwitch
                            class="mx-1"
                ...
                <CCard>
                    ...
                    <CCardBody class="p-0">
                        ...
                        >
                            ...
                            <template #sizeProp="{item}">
                                <td>
                                    <span v-html="item.sizeProp"></span>
                                </td>
                            </template>
                        </CDataTable>
                    </CCardBody>
            ...
            items: [
                {
                    ...
                    sizeProp: 'Add following prop <code>size="lg"</code>',
                },
                {
                    size: "Normal",
                    example: {
                ...
                },
                {
                    ...
                    sizeProp: 'Add following prop <code>size="sm"</code>',
                },
            ],
            checker: true,
            radio: "warning",

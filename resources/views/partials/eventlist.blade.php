<div class="calender">
    <div class="calendar_date--big">
        <div class="calendar_date">
            <div class="calendar_date_month">{{ \Carbon\Carbon::today()->translatedFormat('D, M') }}</div>
            <div class="calendar_date_day">{{ \Carbon\Carbon::today()->translatedFormat('d') }}</div>
        </div>
            ...
            @forelse ($events as $event)
                ...
                <li class="media mb-3">
                    <div class="mr-3 calendar_date">
                        <div class="calendar_date_month">{{ $event->date->translatedFormat('M') }}</div>
                        <div class="calendar_date_day">{{ $event->date->translatedFormat('d') }}</div>
                    </div>
                    <div class="media-body calendar_day">
                        <div class="calendar_day_body">{!! $event->text !!}</div>
